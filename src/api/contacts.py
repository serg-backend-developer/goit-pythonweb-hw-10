...
@router.get("/birthdays", response_model=list[ContactResponseModel], summary="Get upcoming birthdays")
...
@router.get("/{contact_id}", response_model=ContactResponseModel, summary="Get exact contact")
...
@router.post(
    "/", response_model=ContactResponseModel, status_code=status.HTTP_201_CREATED, summary="Create new contact"
)
...
@router.put("/{contact_id}", response_model=ContactResponseModel, summary="Update exist contact")
...
@router.delete("/{contact_id}", response_model=ContactResponseModel, summary="Delete exist contact")
